...
- [📗 Table of Contents ](#-table-of-contents-)
  - [📖 CAD \& CAM Training ](#-cad--cam-training-)
...
## 📖 CAD & CAM Training <a name="cad--cam-training"></a>

> This is a registration page for the `CAD & CAM` training 2023 program organised by the Air Force Institute of Technology (AFIT).
...
- **Users can register for training**
- **See details about training**
...
```sh
  git clone git@github.com:PraisesPJMT/afit-cad-registration.git
  cd afit-cad-registration
```
